...
/** */
public class ViewEGL extends GLSurfaceView
{
    public static final String LOG_TAG = "ViewEGL";

    public static final int GLES_VERSION = 1;
     ...
     * @param context
     */
    public ViewEGL( Context context )
    {
        /////////////////
        super( context );
        /////////////////
     ...
     * @param attrs
     */
    public ViewEGL( Context context, AttributeSet attrs )
    {
        ////////////////////////
        super( context, attrs );
        ////////////////////////
     ...
     * @param stencil
     */
    public ViewEGL( Context context, boolean translucent, int depth, int stencil )
    {
        /////////////////
        super( context );
        /////////////////
    ...
    protected void init( boolean translucent, int depth, int stencil )
    {
        ...
        setEGLContextClientVersion( ViewEGL.GLES_VERSION );
    }
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory
    {
        ...
        public EGLContext createContext( EGL10 egl, EGLDisplay display, EGLConfig eglConfig )
        {
            if ( GLES_VERSION == 1 )
            {
                Log.w( LOG_TAG, "Creating OpenGL ES 1 context..." );
            }
            else if ( GLES_VERSION == 2 )
            {
                Log.w( LOG_TAG, "Creating OpenGL ES 2 context..." );
            }
